...
func (info ModelProviderInfo) String() string {
        return fmt.Sprintf("ModelProviderInfo{ProviderID:%d, ProviderName:%s, ProviderModelName:%s, BaseURL:%s, APIKey:%s, Timeout:%d, ConnectTimeout:%d, FirstTokenTimeout:%d, StreamIdleTimeout:%d, Retry:%d, Status:%s}",
